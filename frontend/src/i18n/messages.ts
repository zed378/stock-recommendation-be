...
export const id = {
  ...
  "export.page": "hal.",
  "admin.issuers.subSectorFilter": "Semua subsektor",
  "multiSelect.count": "{count} dipilih",
  "multiSelect.clear": "Bersihkan pilihan",
  "multiSelect.noMatches": "Tidak ada yang cocok",
...
export const en: Record<MessageKey, string> = {
  ...
  "export.page": "page",
  "admin.issuers.subSectorFilter": "All sub-sectors",
  "multiSelect.count": "{count} selected",
  "multiSelect.clear": "Clear selection",
  "multiSelect.noMatches": "Nothing matches",
