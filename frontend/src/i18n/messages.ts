...
export const id = {
  ...
  "scan.title": "Pemindaian pasar",
  "scan.tab.watchlist": "Watchlist saya",
  "scan.tab.global": "Seluruh bursa",
  "scan.criteria": "Semua kriteria",
  "scan.asOf": "Data {when}",
  "scan.matchedCount": "{count} kriteria",
  "scan.emptyWatchlist": "Tidak ada emiten watchlist yang cocok.",
  "scan.emptyGlobal": "Belum ada hasil pemindaian.",
  "scan.emptyHint": "Pemindaian berjalan setelah ringkasan bursa harian masuk. Admin bisa memicunya lebih awal dari halaman antrean.",
  ...
  "admin.settings.marketCron": "Jadwal impor & pemindaian pasar (cron)",
  "admin.settings.marketCronHint": "Dibaca dalam waktu bursa (WIB). Bawaan 0 18 * * 1-5 — sejam setelah penutupan, hari kerja saja. Kosongkan untuk mematikan.",
  "admin.settings.jitter": "Sebaran acak (detik)",
  "admin.settings.jitterHint": "Sebaran acak dalam detik. Permintaan yang mendarat tepat pukul 18:00:00 setiap hari kerja adalah jadwal, dan jadwal itulah yang dibatasi rate limit. 0 mematikan sebaran.",
  "admin.market.title": "Pemicu manual",
  "admin.market.hint": "Impor menarik rekaman sesi hari ini lalu memicu pemindaian. Pemindaian saja menghitung ulang tanpa jaringan. Backfill mengisi riwayat, satu job per sesi.",
  "admin.market.fetch": "Impor hari ini",
  "admin.market.scan": "Pindai sekarang",
  "admin.market.backfill": "Isi riwayat",
  "admin.market.queued": "Pekerjaan diantrekan",
  ...
  "profile.title": "Profil investasi",
  "profile.intro": "Analisis dibingkai untuk pembaca tertentu. Yang Anda pilih di sini mengubah penekanan, urutan, dan seberapa banyak dijelaskan \u2014 bukan kesimpulannya.",
  "profile.howYouInvest": "Cara Anda berinvestasi",
  "profile.saved": "Preferensi tersimpan",
  "profile.notStated": "(bawaan, belum Anda pilih)",
  "profile.framingCaveat": "Profil ini mengubah cara analisis ditulis, bukan isinya. Sikap, level, dan confidence adalah sifat buktinya \u2014 dua orang yang melihat emiten yang sama pada hari yang sama melihat fakta yang sama.",
  "profile.investment_horizon": "Horizon",
  "profile.investment_horizon.hint": "Jendela waktu yang Anda pakai membaca sebuah posisi.",
  "profile.investment_horizon.short": "Pendek (hari\u2013minggu)",
  "profile.investment_horizon.medium": "Menengah (minggu\u2013bulan)",
  "profile.investment_horizon.long": "Panjang (tahun)",
  "profile.risk_appetite": "Sikap terhadap risiko",
  "profile.risk_appetite.hint": "Menentukan seberapa rinci sisi buruk dijabarkan, bukan seberapa sering sesuatu disebut layak beli.",
  "profile.risk_appetite.conservative": "Konservatif",
  "profile.risk_appetite.moderate": "Moderat",
  "profile.risk_appetite.aggressive": "Agresif",
  "profile.experience_level": "Kosakata pasar",
  "profile.experience_level.hint": "Apakah istilah teknikal perlu dijelaskan saat pertama muncul.",
  "profile.experience_level.beginner": "Pemula",
  "profile.experience_level.intermediate": "Menengah",
  "profile.experience_level.advanced": "Mahir",
  "profile.explanation_depth": "Kedalaman penjelasan",
  "profile.explanation_depth.hint": "Seberapa panjang narasi yang Anda inginkan.",
  "profile.explanation_depth.brief": "Ringkas",
  "profile.explanation_depth.standard": "Standar",
  "profile.explanation_depth.detailed": "Rinci",
  "profile.privacy_mode": "Mode privasi",
  "profile.privacy_mode.hint": "Mode tinggi mengarahkan data pribadi hanya ke penyedia swakelola.",
  "profile.privacy_mode.standard": "Standar",
  "profile.privacy_mode.high": "Tinggi",
  "agenda.title": "Agenda emiten",
  "agenda.watchlistOnly": "Hanya watchlist saya",
  "agenda.notAForecast": "Ini jadwal, bukan ramalan",
  "agenda.caveatFallback": "Tanggal sebagaimana diumumkan. Halaman ini tidak berpendapat tentang apa yang akan dilakukan sebuah peristiwa terhadap harga.",
  "agenda.empty": "Tidak ada agenda pada rentang ini",
  "agenda.emptyHint": "Agenda diisi dari entri manual admin dan dari berita bertanggal yang sudah ditandai ke emiten.",
  "agenda.footer": "Tanggal yang berasal dari liputan bisa berubah dan ditandai sumbernya. Periksa ke sumber aslinya sebelum merencanakan apa pun di sekitarnya.",
  "agenda.kind.earnings": "Laporan keuangan",
  "agenda.kind.rups": "RUPS",
  "agenda.kind.dividend": "Dividen",
  "agenda.kind.ex_date": "Ex/cum date",
  "agenda.kind.stock_split": "Stock split",
  "agenda.kind.rights_issue": "Rights issue",
  "agenda.kind.other": "Lainnya",
  "agenda.source.exchange": "bursa",
  "agenda.source.news": "dari berita",
  "agenda.source.manual": "entri manual",
  "shared.title": "Berbagi",
  "shared.intro": "Tidak ada tautan berbagi di sini, dan itu disengaja: URL yang memuat analisis investasi tentang emiten tertentu akan meneruskan dirinya sendiri dan tidak bisa ditarik kembali. Berbagi selalu ke akun yang disebut namanya.",
  "shared.incoming": "Dibagikan kepada Anda",
  "shared.outgoing": "Anda bagikan",
  "shared.noIncoming": "Belum ada yang dibagikan kepada Anda",
  "shared.noIncomingHint": "Yang muncul di sini hanya dari akun lain pada platform ini.",
  "shared.noOutgoing": "Anda belum membagikan apa pun",
  "shared.share": "Bagikan sesuatu",
  "shared.recipient": "Akun penerima",
  "shared.recipientHint": "Harus akun yang sudah ada di platform ini.",
  "shared.what": "Yang dibagikan",
  "shared.kindWatchlist": "Watchlist",
  "shared.kindAnalysis": "Analisis",
  "shared.pickWatchlist": "Pilih watchlist",
  "shared.choose": "Pilih\u2026",
  "shared.analysisId": "ID analisis",
  "shared.analysisIdHint": "Disalin dari halaman analisis emiten.",
  "shared.note": "Catatan (opsional)",
  "shared.send": "Bagikan",
  "shared.sent": "Dibagikan",
  "shared.revoke": "Tarik kembali",
  "shared.revoked": "Akses ditarik",
  "shared.revokedOn": "ditarik",
  "shared.ownerCaveat": "Berbagi memberi akses ke aslinya, bukan salinan: penerima melihat versi terkini, dan menarik kembali mencabut aksesnya. Penerima tidak bisa membagikan ulang.",
  "shared.recipientCaveat": "Analisis yang dibagikan dibingkai untuk horizon dan sikap risiko pengirim, bukan Anda. Ini analisis hasil AI untuk informasi, bukan nasihat investasi dari penasihat berlisensi.",
  "evidence.title": "Dasar rekomendasi",
  "evidence.intro": "Level yang disebut analisis, digambar di atas harga yang dibacanya.",
  "evidence.altText": "Grafik harga dengan level support, resistance, target, dan stop yang disebut analisis.",
  "evidence.none": "Belum ada rekomendasi tersimpan",
  "evidence.noneHint": "Grafik ini menandai apa yang dikatakan sebuah analisis; ia tidak menggambar apa pun sendiri. Jalankan analisis lebih dulu.",
  "evidence.noBars": "Tidak ada riwayat harga",
  "evidence.noBarsHint": "Impor harga untuk emiten ini lebih dulu.",
  "evidence.supporting": "Mendukung",
  "evidence.conflicting": "Bertentangan",
  "evidence.level.support_level": "Support",
  "evidence.level.resistance_level": "Resistance",
  "evidence.level.target_price": "Target",
  "evidence.level.suggested_stop": "Stop usulan",
  "nav.agenda": "Agenda",
  "nav.shared": "Berbagi",
  "nav.profile": "Profil",
  ...
  "picks.unevaluable": "Tidak bisa dinilai (riwayat belum cukup)",
  ...
  "alerts.searchPlaceholder": "Cari kode emiten…",
  ...
  "alert.support_approached": "Mendekati support",
  "alert.resistance_broken": "Menembus resisten",
  "alert.support_broken": "Jebol di bawah support",
  "alert.false_breakout": "Breakout gagal bertahan",
  "alert.volume_spike": "Lonjakan volume",
  "alert.volume_spike_quiet": "Volume melonjak, harga belum",
  "alert.golden_cross": "Golden cross (MA10/MA50)",
  "alert.death_cross": "Death cross (MA10/MA50)",
  "alert.macd_crossed": "MACD memotong garis sinyal",
  "alert.rsi_oversold": "RSI di bawah 30",
  "alert.rsi_overbought": "RSI di atas 70",
  "alert.stochastic_oversold": "Stochastic di bawah 20",
  "alert.stochastic_overbought": "Stochastic di atas 80",
  "alert.gap_up": "Gap naik saat pembukaan",
  "alert.gap_down": "Gap turun saat pembukaan",
  "alert.support_with_divergence": "Support + divergensi bullish",
  "alert.at_52_week_high": "Di titik tertinggi 52 minggu",
  "alert.at_52_week_low": "Di titik terendah 52 minggu",
  "alert.volatility_squeeze": "Bollinger menyempit",
  "alert.range_expansion": "Rentang harian melebar",
  "alert.reward_to_risk_reached": "Rasio imbal-risiko tercapai",
  "alert.agenda_upcoming": "Agenda emiten mendekat",
  "alert.trailing_stop_reached": "Turun dari puncak sejak dicatat",
  "alert.foreign_flow_spike": "Aliran dana asing tidak biasa",
...
export const en: Record<MessageKey, string> = {
  ...
  "scan.title": "Market scan",
  "scan.tab.watchlist": "My watchlist",
  "scan.tab.global": "Whole exchange",
  "scan.criteria": "All criteria",
  "scan.asOf": "As of {when}",
  "scan.matchedCount": "{count} criteria",
  "scan.emptyWatchlist": "None of your watchlist tickers matched.",
  "scan.emptyGlobal": "No scan results yet.",
  "scan.emptyHint": "The scan runs once the daily exchange summary lands. An admin can trigger it earlier from the queue page.",
  ...
  "admin.settings.marketCron": "Market import & scan schedule (cron)",
  "admin.settings.marketCronHint": "Read in exchange time (WIB). Defaults to 0 18 * * 1-5 — an hour after the close, weekdays only. Empty turns it off.",
  "admin.settings.jitter": "Random spread (seconds)",
  "admin.settings.jitterHint": "Random spread in seconds. A request landing at exactly 18:00:00 every weekday is a schedule, and a schedule is what rate limiting is for. 0 disables the spread.",
  "admin.market.title": "Manual triggers",
  "admin.market.hint": "Import pulls today’s session record and chains the scan. Scan alone recomputes with no network. Backfill fills in history, one job per session.",
  "admin.market.fetch": "Import today",
  "admin.market.scan": "Scan now",
  "admin.market.backfill": "Backfill history",
  "admin.market.queued": "Job queued",
  ...
  "profile.title": "Investment profile",
  "profile.intro": "Analysis is framed for a particular reader. What you choose here changes emphasis, ordering and how much gets explained \u2014 never the conclusion.",
  "profile.howYouInvest": "How you invest",
  "profile.saved": "Preference saved",
  "profile.notStated": "(default, not yet your choice)",
  "profile.framingCaveat": "This profile changes how an analysis is written, not what it finds. The stance, the levels and the confidence are properties of the evidence \u2014 two people looking at the same issuer on the same day are looking at the same facts.",
  "profile.investment_horizon": "Horizon",
  "profile.investment_horizon.hint": "The window you read a position over.",
  "profile.investment_horizon.short": "Short (days\u2013weeks)",
  "profile.investment_horizon.medium": "Medium (weeks\u2013months)",
  "profile.investment_horizon.long": "Long (years)",
  "profile.risk_appetite": "Attitude to risk",
  "profile.risk_appetite.hint": "Sets how fully the downside is spelled out, not how often something is called a buy.",
  "profile.risk_appetite.conservative": "Conservative",
  "profile.risk_appetite.moderate": "Moderate",
  "profile.risk_appetite.aggressive": "Aggressive",
  "profile.experience_level": "Market vocabulary",
  "profile.experience_level.hint": "Whether technical terms are explained the first time they appear.",
  ...
  "profile.explanation_depth": "Depth of explanation",
  "profile.explanation_depth.hint": "How long you want the narrative to be.",
  "profile.explanation_depth.brief": "Brief",
  "profile.explanation_depth.standard": "Standard",
  "profile.explanation_depth.detailed": "Detailed",
  "profile.privacy_mode": "Privacy mode",
  "profile.privacy_mode.hint": "High routes personal data to self-hosted providers only.",
  "profile.privacy_mode.standard": "Standard",
  "profile.privacy_mode.high": "High",
  "agenda.title": "Issuer calendar",
  "agenda.watchlistOnly": "My watchlist only",
  "agenda.notAForecast": "This is a schedule, not a forecast",
  "agenda.caveatFallback": "Dates as disclosed. This page holds no view on what any event will do to a price.",
  "agenda.empty": "Nothing scheduled in this window",
  "agenda.emptyHint": "The calendar is filled from operator entries and from dated coverage already tagged to an issuer.",
  "agenda.footer": "Dates taken from coverage can move and are marked as such. Check the original source before planning around one.",
  "agenda.kind.earnings": "Financial report",
  "agenda.kind.rups": "Shareholder meeting",
  "agenda.kind.dividend": "Dividend",
  "agenda.kind.ex_date": "Ex/cum date",
  "agenda.kind.stock_split": "Stock split",
  "agenda.kind.rights_issue": "Rights issue",
  "agenda.kind.other": "Other",
  "agenda.source.exchange": "exchange",
  "agenda.source.news": "from coverage",
  "agenda.source.manual": "entered manually",
  "shared.title": "Sharing",
  "shared.intro": "There is no share link here, deliberately: a URL carrying investment analysis about a named company forwards itself and cannot be withdrawn. Sharing is always to a named account.",
  "shared.incoming": "Shared with you",
  "shared.outgoing": "You have shared",
  "shared.noIncoming": "Nothing has been shared with you",
  "shared.noIncomingHint": "Only accounts on this platform can appear here.",
  "shared.noOutgoing": "You have not shared anything",
  "shared.share": "Share something",
  "shared.recipient": "Recipient account",
  "shared.recipientHint": "Must already be an account on this platform.",
  "shared.what": "What to share",
  "shared.kindWatchlist": "Watchlist",
  "shared.kindAnalysis": "Analysis",
  "shared.pickWatchlist": "Pick a watchlist",
  "shared.choose": "Choose\u2026",
  "shared.analysisId": "Analysis id",
  "shared.analysisIdHint": "Copied from the issuer analysis page.",
  "shared.note": "Note (optional)",
  "shared.send": "Share",
  "shared.sent": "Shared",
  "shared.revoke": "Withdraw",
  "shared.revoked": "Access withdrawn",
  "shared.revokedOn": "withdrawn",
  "shared.ownerCaveat": "Sharing grants access to the original, not a copy: the recipient sees the current version, and withdrawing removes their access. Recipients cannot re-share.",
  "shared.recipientCaveat": "A shared analysis was framed for the sender\u2019s horizon and risk appetite, not yours. It is AI-generated analysis for information, not advice from a licensed adviser.",
  "evidence.title": "What the recommendation rests on",
  "evidence.intro": "The levels the analysis named, drawn on the prices it read.",
  "evidence.altText": "Price chart with the support, resistance, target and stop levels the analysis named.",
  "evidence.none": "No stored recommendation yet",
  "evidence.noneHint": "This chart marks what an analysis said; it draws nothing on its own. Run an analysis first.",
  "evidence.noBars": "No price history",
  "evidence.noBarsHint": "Import prices for this issuer first.",
  "evidence.supporting": "Supporting",
  "evidence.conflicting": "Contradicting",
  "evidence.level.support_level": "Support",
  "evidence.level.resistance_level": "Resistance",
  "evidence.level.target_price": "Target",
  "evidence.level.suggested_stop": "Suggested stop",
  "nav.agenda": "Calendar",
  "nav.shared": "Sharing",
  "nav.profile": "Profile",
  ...
  "picks.unevaluable": "Could not be checked (not enough history)",
  "picks.unmet": "Not met",
  ...
  "alerts.searchPlaceholder": "Search a ticker code…",
  ...
  "alert.support_approached": "Support approached",
  "alert.resistance_broken": "Closed above resistance",
  "alert.support_broken": "Closed below support",
  "alert.false_breakout": "Breakout did not hold",
  "alert.volume_spike": "Volume spike",
  "alert.volume_spike_quiet": "Volume up, price not yet",
  "alert.golden_cross": "Golden cross (MA10/MA50)",
  "alert.death_cross": "Death cross (MA10/MA50)",
  "alert.macd_crossed": "MACD crossed its signal line",
  "alert.rsi_oversold": "RSI below 30",
  "alert.rsi_overbought": "RSI above 70",
  "alert.stochastic_oversold": "Stochastic below 20",
  "alert.stochastic_overbought": "Stochastic above 80",
  "alert.gap_up": "Opened with a gap up",
  "alert.gap_down": "Opened with a gap down",
  "alert.support_with_divergence": "Support + bullish divergence",
  "alert.at_52_week_high": "At its 52-week high",
  "alert.at_52_week_low": "At its 52-week low",
  "alert.volatility_squeeze": "Bollinger bands compressed",
  "alert.range_expansion": "Session range expanded",
  "alert.reward_to_risk_reached": "Reward-to-risk ratio reached",
  "alert.agenda_upcoming": "Scheduled event approaching",
  "alert.trailing_stop_reached": "Fell from its peak since recorded",
  "alert.foreign_flow_spike": "Unusual net foreign flow",
